...
状态：计划已编写；下述性能替换均未实现，真实宿主性能修复尚未验证（2026-09-13）。
...
本次交付仅为计划文档与入口更新，未修改运行代码，也未执行新一轮构建或真实宿主性能回归。后续交付必须同时具有代码差异、专项结果和真实 Guitar Pro 性能证据；“DLL 加载成功”“菜单可见”“fixture PASS”均不能单独证明周期卡顿已消除。
