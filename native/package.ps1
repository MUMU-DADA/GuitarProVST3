...
Copy-Item -LiteralPath (Join-Path $root 'docs/INSTALL.md'), (Join-Path $root 'docs/P8_IMPLEMENTATION.md'), (Join-Path $root 'docs/P8_TRACK_GLOBAL_VST3_PLAN.md'), (Join-Path $root 'docs/P9_IMPLEMENTATION.md'), (Join-Path $root 'docs/P9_AUDIO_SWITCH_UI_PLAN.md'), (Join-Path $root 'docs/P10_ASIO_LATENCY_INPUT_PLAN.md'), (Join-Path $root 'docs/P10_IMPLEMENTATION.md'), (Join-Path $root 'docs/P11_STARTUP_SCAN_INPUT_PLAN.md'), (Join-Path $root 'docs/P11_IMPLEMENTATION.md'), (Join-Path $root 'docs/REALTIME_IMPLEMENTATION_PLAN.md'), (Join-Path $root 'docs/TESTING.md'), (Join-Path $root 'LICENSE'), (Join-Path $root 'DISCLAIMER.md') -Destination (Join-Path $staging 'docs')
