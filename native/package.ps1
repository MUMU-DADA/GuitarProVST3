...
Copy-Item -LiteralPath (Join-Path $root 'docs/INSTALL.md'), (Join-Path $root 'docs/P6_IMPLEMENTATION.md'), (Join-Path $root 'LICENSE') -Destination (Join-Path $staging 'docs')
