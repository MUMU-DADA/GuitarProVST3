...
Copy-Item -LiteralPath (Join-Path $root 'docs/INSTALL.md'), (Join-Path $root 'docs/P8_IMPLEMENTATION.md'), (Join-Path $root 'docs/P8_TRACK_GLOBAL_VST3_PLAN.md'), (Join-Path $root 'docs/REALTIME_IMPLEMENTATION_PLAN.md'), (Join-Path $root 'docs/TESTING.md'), (Join-Path $root 'LICENSE'), (Join-Path $root 'DISCLAIMER.md') -Destination (Join-Path $staging 'docs')
