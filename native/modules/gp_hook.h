...
struct State {
    ...
    std::uint64_t chainDeadlineNanoseconds = 0;
    std::size_t chainDeadlineExceededBlocks = 0;
    ...
    std::size_t inputInterleavedCopyOperations = 0;
    ...
    std::uint64_t audioCallbackBlocks = 0;
    std::uint64_t firstAudioCallbackNanoseconds = 0;
    std::uint64_t audioCallbackProcessingNanoseconds = 0;
    std::uint64_t audioCallbackMaxNanoseconds = 0;
    std::uint64_t audioCallbackP95Nanoseconds = 0;
    std::uint64_t audioCallbackP99Nanoseconds = 0;
    std::uint64_t audioCallbackDeadlineNanoseconds = 0;
    std::size_t audioCallbackDeadlineOverruns = 0;
    std::size_t audioCallbackExtraCopyOperations = 0;
    std::size_t deviceInputLatencySamples = 0;
    std::size_t deviceOutputLatencySamples = 0;
    std::size_t vst3LatencySamples = 0;
    std::size_t adapterLatencySamples = 0;
    std::size_t roundtripLatencySamples = 0;
    bool roundtripLatencyMeasured = false;
    std::string roundtripLatencyStatus = "unavailable";
